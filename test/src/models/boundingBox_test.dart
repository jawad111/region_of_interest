...
void main() {
  group('TransformationController Tests', () {
    test('Transform Point', () {
      ...
      Size primaryCoordinateSystem = Size(1920, 1080);

      // Define a secondary coordinate system (image resolution)
      Size secondaryCoordinateSystem = Size(800, 600);

      // Define a point in the primary coordinate system
      Offset pointInPrimary = Offset(100, 200);
      ...
      expect(transformedPoint, equals(Offset(266.6666666666667, 400.0)));
    });

    test('Decrease Image Ratio', () {
      // Define the original image resolution
      Size originalResolution = Size(800, 600);
      ...
      expect(decreasedResolution, equals(Size(400.0, 300.0)));
    });
    ...
    test('Calculate Region of Interest on Screen', () {
      ...
      expect(regionOnScreen, equals([Offset(100, 200), Offset(150, 200), Offset(100, 250), Offset(150, 250)]));
    });
    ...
    test('Transform Region of Interest on Image', () {
      ...
      Size screenResolution = Size(1920, 1080);
      Size imageResolution = Size(800, 600);
