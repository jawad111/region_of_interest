...
void main() {
  test('ImageProcessingManager - Process Image', () async {
    // Arrange
    final XFile mockXFile  = XFile("https://www.google.com/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png");
    ...
    // Act
    await ImageProcessingManager.process(mockXFile, {'x': 10.0, 'y': 20.0, 'w': 20.0, 'h': 20.0}, screenDisplaySize, callback);
